...
public class Base {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\Ekramul\\eclipse-workspace\\CNSAssignment\\driver\\chromedriver.exe");
		...
		driver.findElement(By.xpath("//td[normalize-space()='Prattoy-Circular']")).click();	
        ...
        //basicInformation Class Call
         basicInformation(driver);
        ...
        //address Class Call
         ...
         //jobExperience Class Call
         jobExperience(driver);
         
         //certificate Class Call
         certificate(driver);
        
         //finalSubmit Class Call
         finalSubmit(driver);
	...
	@Test
	public static void basicInformation(WebDriver driver) throws InterruptedException
	{
    ////////////////////////////////////Start Basic Information/////////////////////////////////////////////////
     ...
     Thread.sleep(3000);
     driver.findElement(By.id("national_id_attachment")).sendKeys("C:\\Users\\Ekramul\\eclipse-workspace\\CNSAssignment\\image\\Ekramul Nid.JPG");
     Thread.sleep(5000);
   ...
   //Select  Religion
    ...
    driver.findElement(By.xpath("//input[@id='photo']")).sendKeys("C:\\Users\\Ekramul\\eclipse-workspace\\CNSAssignment\\image\\Pic_300.jpg");
    Thread.sleep(2000);
    //Upload SIGNATURE (300PX X 80PX) (UPTO 60KB)
    driver.findElement(By.xpath("//input[@id='signature']")).sendKeys("C:\\Users\\Ekramul\\eclipse-workspace\\CNSAssignment\\image\\Sig_300.jpg");
    Thread.sleep(2000);
   //Upload QUOTA ATTACHMENT (UPTO 600KB)
    driver.findElement(By.xpath("//input[@id='quota_attachment']")).sendKeys("C:\\Users\\Ekramul\\eclipse-workspace\\CNSAssignment\\image\\QUOTA ATTACHMENT.JPG");
    Thread.sleep(2000);
	...
	@Test
	public static void jobExperience(WebDriver driver) throws InterruptedException
	{
     ////////////////////////////////////Add Job Experience ///////////////////////////////////////////////// 
     Thread.sleep(2000);
	...
	@Test
	public static void certificate(WebDriver driver) throws InterruptedException
	{
       ////////////////////////////////////Add Certificate ///////////////////////////////////////////////// 
       // Set Course
       Thread.sleep(2000);
	...
	@Test
	public static void finalSubmit(WebDriver driver) throws InterruptedException
	{
     ////////////////////////////////////SartComplete /////////////////////////////////////////////////
